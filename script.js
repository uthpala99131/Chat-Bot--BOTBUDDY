...
try{
    ...
    const apiResponseText = DataTransfer.candidates[0].content.parts[0].text.trim();
...
const simulateBotResponse = () => {
    ...
    setTimeout(() => {
        ...
        generateBotResponse(incomingMessageDiv);// Auto-scroll to the latest message
    },600); // 2-second delay for bot response
};
...
setTimeout(() => {
    const messageContent = `<svg class="bot-avatar" xmlns="http://www.w3.org/2000/svg" width="50" height="50" viewBox="0 0 1024 1024">
        ...
        <div class="message-text">${bot-message.message}</div>`;
